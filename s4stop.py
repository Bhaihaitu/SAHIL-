...
bot_token = '7850332533:AAEXNz67Eh0pqbrM8RpS9Yt_KRndzVgjx44'
admin_id = '6882674372,1604629264'  # Replace with your actual admin user ID
GROUP_ID = '-1002252002504'  # Allowed group ID
...
def handle_bgmi(message):
    ...
    full_command = f"./Rahul {target} {port} {attack_time} 900"
...
def stop_attack(call):
    ...
    if user_id in running_attacks:
        ...
        bot.send_message(user_id, "📢 𝗔𝗧𝗧𝗔𝗖𝗞 𝗦𝗧𝗢𝗣 𝗕𝗬 𝗔𝗗𝗠𝗜𝗡 ")
